            ...
            <div class="yui3-g home">
                ...
                <div class="yui3-u-5-6 order-pay">
                    <div class="body userInfo">
                        ...
                        <%--
                        enctype="application/x-www-form-urlencoded" 这是默认值，支持普通的字符数据传递给服务器
                        enctype="multipart/form-data" 支持文件流和字符数据传递给服务器
                        --%>
                                ...
                                <div id="one" class="tab-pane active">
                                    <div class="sui-form form-horizontal">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" id="inputName" name="nickname" value="${loginUser.nickname}" placeholder="昵称">
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                ...
                                                <input type="radio" name="sex" value="1" ${loginUser.sex=='1'?'checked="checked"':''}><b>男</b>
                                                &nbsp;&nbsp;
                                                <input type="radio" name="sex" value="0" ${loginUser.sex=='0'?'checked="checked"':''}><b>女</b>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                        ...
                                        <div class="upload">
                                            <c:if test="${empty loginUser.pic}">
                                                <img id="imgShow_WU_FILE_0" width="100" height="100"
                                                     src="${ctx}/img/girl.png"
                                                     alt="">
                                            </c:if>
                                            <c:if test="${not empty loginUser.pic}">
                                                <img id="imgShow_WU_FILE_0" width="100" height="100"
                                                     src="${ctx}/${loginUser.pic}"
                                                     alt="">
                                            </c:if>
