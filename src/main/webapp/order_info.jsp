...
<div class="container-fluid">
    <form action="${ctx}/OrderServlet?action=addOrder" method="post">
                                ...
                                <li class="addr-item">
                                    ...
                                    <div>
                                        ...
                                        <div class="con address">
                                            <input type="radio"  ${address.isdefault=='1'?'checked="checked"':''} name="addressId" value="${address.aid}">
                                           ${address.contact}
                            ...
                            <ul class="send-detail">
                                <li>
                                    <div class="sendGoods">
                                        ...
                                        <ul class="yui3-g">
                                            <li class="yui3-u-1-6">
                                                <span><img src="${ctx}/${entry.value.route.rimage}"/></span>
                                            </li>
                                            ...
                                            <li class="yui3-u-1-12">
                                                <div class="price">${entry.value.route.price}.00</div>
                                            </li>
                                            <li class="yui3-u-1-12">
