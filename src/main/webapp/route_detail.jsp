...
<div class="wrap">
    <div class="bread_box">
        ...
        <span> &gt;</span>
        <a href="${ctx}/RouteServlet?action=findByPage&cid=${route.cid}">${route.category.cname}</a><span> &gt;</span>
        <a href="#">${route.rname}</a>
    </div>
    <div class="prosum_box">
        <dl class="prosum_left">
            <dt>
                <img alt="" class="big_img" src="${ctx}/${route.routeImgList[0].bigPic}">
            </dt>
            <dd>
                <a class="up_img up_img_disable"></a>
                <c:forEach items="${route.routeImgList}" var="routeImg" varStatus="status">
                    <a title="" class="little_img" data-bigpic="${ctx}/${routeImg.bigPic}"
                        ${status.index>3?'style="display:none;"':''}
                    >
                        <img src="${ctx}/${routeImg.smallPic}">
                    </a>
                </c:forEach>
        ...
        <div class="prosum_right">
            ...
            <div class="pros_price">
                ...
                <div class="p_number">
                    ...
                    <span class="collect">
                         <a class="btn" href="javascript:addCart();" id="addCart"><i class="glyphicon glyphicon-heart-empty"></i>加入购物车</a>
                    </span>
                </div>
                <script>
                    function addCart() {
                        ...
                        if(${empty loginUser}){
                            ...
                            location.href=`${ctx}/CartServlet?action=addCart&rid=${route.rid}&num=\${num}`;
                        }
