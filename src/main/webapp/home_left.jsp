...
<div class="yui3-u-1-6 list">
    ...
    <div class="person-info">
        <div class="person-photo" style="text-align: center">
            <c:if test="${empty loginUser.pic}">
                <img src="${ctx}/img/girl.png" width="160px" class="img-circle" alt="">
            </c:if>
            <c:if test="${not empty loginUser.pic}">
                <img src="${ctx}/${loginUser.pic}" width="160px" class="img-circle" alt="">
            </c:if>
        </div>
    ...
    <div class="list-items">
        <dl>
            ...
            <dd><a href="${ctx}/AddressServlet?action=findListByUid">地址管理</a></dd>
        </dl>
        <dl>
            <dt><i>·</i> 订单中心</dt>
